...
def memberListItem(documentation, typeElement, memberElement):
	result = "<li>"
	result = result + memberElement.Member.Name
	result = result + ": "
	result = result + memberElement.XmlComment.Summary
	if memberElement.Member.DeclaringType != typeElement.Type:
		result = result + " (inherited from " + typeLink(documentation, memberElement.Member.DeclaringType) + ")"
	result = result + "</li>"
	return result
...
def typeProperties(documentation, typeElement):
	...
	for p in typeElement.Properties:
		result = result + memberListItem(documentation, typeElement, p)
	if len(result):
...
def Generate(documentation):
	...
	footer = """<footer>
	Generated by IglooCastle at """ + strftime("%Y-%m-%d %H:%M:%S", gmtime()) + """
